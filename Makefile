...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/jing-zhou/clash/constant.Version=$(VERSION)" \
		-X "github.com/jing-zhou/clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
